<div id="main-game-container">
    ...
    <div class="user-bar">
        玩家: <span id="user-name" class="username-highlight"><?php echo htmlspecialchars($_SESSION['username'] ?? '載入中...'); ?></span> | 
    ...
    <div class="controls">
        <div id="start-area">
            <button id="action-btn" class="btn-start">開始新局 (底注 $100)</button>
        </div>
        
        <div id="bet-area" class="hide">
            <button id="btn-fold" class="btn-fold">棄牌 (Fold)</button>
            <button id="btn-check" class="btn-check">看牌 (Check)</button>
            <button id="call-btn" class="btn-call">跟注 $200</button>
        </div>
    </div>
</div>